...
let terapistal = '816416118444654643' 
if(!["816416118444654643"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
 ...
 member.roles.add(terapistal)
  let embed = new Discord.MessageEmbed()
  .setColor('RANDOM')
  .setDescription(`${member} kişisi artık ${terapistal}! .`)
  .setTimestamp()
